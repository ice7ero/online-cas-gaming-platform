...
<body class="theme-<?php echo e(config('settings.theme.mode')); ?>" onload="if(window !== window.top) window.top.location = window.location">
  ...
  <script>
    ...
    window.routes = <?php echo json_encode($routes, 15, 512) ?>;
    window.packages = <?php echo json_encode($packages, 15, 512) ?>;
    window.user = <?php echo json_encode($user, 15, 512) ?>;
    window.games = <?php echo json_encode($games, 15, 512) ?>;
  </script>

  <script src="<?php echo e(mix('js/app.js')); ?>"></script>
</body>
</html>
<?php /**PATH E:\my working files\Laravel\codecanyon-sYfiw0lg-stake-online-casino-gaming-platform-single-page-application\resources\views/index.blade.php ENDPATH**/ ?>